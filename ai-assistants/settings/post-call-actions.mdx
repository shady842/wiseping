...
<AccordionGroup>
  ...
  <Accordion title="Webhook URL" icon="link">
    ...
    **Example:** `https://app.wiseping.com/automate/api/v1/webhooks/your-webhook-id`
...
```json
{
  ...
  "transcript": [
    {
      "text": "Hello! This is Sarah from Wise Ping.",
      "type": "transcript",
      "sender": "bot",
  ...
  "formatted_transcript": "AI: Hello! This is Sarah from Wise Ping.\\nCustomer: Hi, I'm doing well, thanks.",
  "recording_url": "https://app.wiseping.com/storage/recordings/call-12345.mp4",
