...
title: "Core Concepts"
icon: "lightbulb"
description: "Learn the fundamental building blocks of Wise Ping, including system prompts, voices, and AI assistants"
---

Welcome to the fundamentals of Wise Ping. Here, we explore the essential building blocks that you need to understand before configuring your AI assistant and calls.
...
- Wise Ping integrates with **ElevenLabs** voices for natural-sounding speech.
