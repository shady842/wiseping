...
title: "Cost Overview"
icon: "dollar-sign"
description: "Understand the main components of Wise Ping pricing, including call minutes, number rentals, and optional fees"
---

Wise Ping uses a **credit/minute system** to track usage for both AI processing and carrier network fees. Here's how it breaks down:
...
2. **Acquire or Verify a Number**: Rent from Wise Ping or add your own as caller ID for outbound.
