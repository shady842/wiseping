...
icon: "phone"
description: "Learn about the different types of phone numbers you can use with Wise Ping: dedicated numbers, SIP integration, and Caller ID"
---

Wise Ping lets you connect three different kinds of phone numbers to your AI assistant:

1. **Normal (Dedicated) Numbers**

   - Rented directly from Wise Ping.
...
2. **SIP Integration (VOIP/PBX)**
   ...
   - This setup allows you to keep your existing numbers while benefiting from Wise Ping's AI.
