---
title: "Wise Ping Tool"
icon: "phone"
description: "Learn how to use Wise Ping triggers and actions in your AI calling flows"
---

# Wise Ping Tool

The Wise Ping tool is the core component that connects your AI calling system with automation flows. It enables real-time data exchange between your AI assistants and business systems, allowing for personalized conversations and automated follow-ups.

<Note>
  You can find the Wise Ping tool prominently displayed at the top of the
...
![Wise Ping Call Ended Trigger](/resources/autocalls-trigger.jpg)
...
![Wise Ping Action](/resources/autocalls-action.jpg)
