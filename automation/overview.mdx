...
description: "Learn about Wise Ping's built-in automation engine for creating workflows without coding"
---
...
Wise Ping includes an internal automation engine (similar to Zapier or Make) that lets you build flows—no coding required. For instance:
...
- **Triggers**: Events inside Wise Ping (e.g., "call ended," "inbound call context injection").
