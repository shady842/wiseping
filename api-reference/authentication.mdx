...
The Wise Ping API uses API keys to authenticate requests. You need to include your API key in the header of each request you make to the API.

## Obtaining an API Key

To obtain an API key:

1. Log in to your Wise Ping account at [https://app.wiseping.com](https://app.wiseping.com)
...
```bash
curl -X GET "https://app.wiseping.com/api/user/campaigns" \
