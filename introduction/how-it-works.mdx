...
description: "Understand the technical flow of how Wise Ping processes and handles phone conversations using AI"
---

Wise Ping blends **AI voice recognition** with **LLM-based replies** to conduct live phone conversations. Below is a simplified flow:

1. **Caller or Lead is Dialed**

   - **Inbound**: A customer dials your assigned phone number.
   - **Outbound**: Wise Ping's system calls a list of phone numbers from your campaign.

2. **Speech Recognition**  
   The AI listens to what the person says and transcribes it into text in real time.

3. **LLM Decision**  
   Wise Ping uses a large language model (LLM) and your configured "system prompt" to craft a reply or decide the next action (like transferring the call).
